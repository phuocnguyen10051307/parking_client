...
export const ROUTE_PERMISSIONS: RoutePermission[] = [
  ...
  { path: '/monthly-subscriptions', allowedRoles: OPERATION_ROLES },
  { path: '/monthly-subscriptions/:id', allowedRoles: OPERATION_ROLES },
  ...
  { path: '/my-monthly-subscriptions', allowedRoles: ['USER'] },
  { path: '/my-monthly-subscriptions/:id', allowedRoles: ['USER'] },
  { path: '/create-monthly-subscription', allowedRoles: ['USER'] },
